...
def bestiole():
    ...
    serpents = can.create_rectangle(300, 300, 310, 310, fill= col)
...
tete = can.create_rectangle(100, 100, 110, 110, fill=col)
carre = can.create_rectangle(112, 100, 122, 110, fill=col)
cercle = can.create_oval(z, y, z + 5, y + 5, fill='red')
