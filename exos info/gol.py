...
def ligne_vert():
    c_x = 0
    while c_x != width:
        can1.create_line(c_x, 0, c_x, height, fill='black')
        c_x += c
...
def ligne_hor():
    c_y = 0
    while c_y != height:
        can1.create_line(0, c_y, width, c_y, fill='black')
        c_y += c
...
dico_case: Dict[Tuple[int, int], int] = {}  # dictionnaire contenant les coordonnées de chaques cellules et une valeur 0 ou 1 si elles sont respectivement mortes ou vivantes
i = 0
